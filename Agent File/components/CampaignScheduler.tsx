            ...
            {selectedContactIds.size > 0 ? (
                <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-100 shrink-0">
                    ...
                    {promptGoal === "Answer a specific spiritual question" && (
                        <div className="mt-3">
                            <input type="text" placeholder="Type the question here..." className="w-full border border-slate-300 rounded-lg px-4 py-2.5 text-base" onChange={(e) => setPromptGoal(`Answer this question: ${e.target.value}`)} />
                        </div>
                    )}
              ...
              <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-8">
                  ...
                  <div className="space-y-5">
                      ...
                      <div className="pt-6 flex gap-4">
                          ...
                          <button onClick={confirmSchedule} disabled={!scheduleDate || !scheduleTime} className="flex-1 py-3 text-white bg-primary-600 rounded-lg hover:bg-primary-700 disabled:opacity-50 text-base font-bold">Confirm Schedule</button>
                      </div>
                  </div>
              </div>
          </div>
